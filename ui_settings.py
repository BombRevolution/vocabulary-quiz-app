...
class SettingsDialog(tk.Toplevel):
    def __init__(self, root, config, db_path):
        ...
        tk.Label(rows, text="每日新词数", font=font(12), bg=COLOR_BG, fg=COLOR_TEXT).grid(row=1, column=0, sticky="w", pady=8)
        ...
        tk.Label(rows, text="忽略大小写", font=font(12), bg=COLOR_BG, fg=COLOR_TEXT).grid(row=2, column=0, sticky="w", pady=8)
        ...
        tk.Label(rows, text="忽略标点", font=font(12), bg=COLOR_BG, fg=COLOR_TEXT).grid(row=3, column=0, sticky="w", pady=8)
